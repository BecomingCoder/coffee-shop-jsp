...
<div id="header-wrapper">
  <div id="header" class="container">
    <div id="logo">
      <h1><a href="#">Zorro 3000's Sip & Dip</a></h1>
</div>
    <div id="menu">
      <ul>
        <li><a href="index.jsp" accesskey="1" title="">Homepage</a></li>
        <li class="current_page_item"><a href="coffee.jsp" accesskey="2" title="">Get Some Coffee!</a></li>
...
<div id="wrapper">
  <div id="featured-wrapper">
    <div id="featured" class="container">
      <div class="column1"> <span class="icon icon-coffee"></span>
        <div class="title">
      ...
      <div class="column2"> <span class="icon icon-coffee"></span>
        <div class="title">
          <h2>Praesent scelerisque</h2>
        </div>
        <p>In posuere eleifend odio. Quisque semper augue mattis wisi. Pellentesque viverra vulputate enim. Aliquam erat volutpat.</p>
      </div>
      <div class="column3"> <span class="icon icon-coffee"></span>
        <div class="title">
          <h2>Fusce ultrices fringilla</h2>
        </div>
        <p>In posuere eleifend odio. Quisque semper augue mattis wisi. Pellentesque viverra vulputate enim. Aliquam erat volutpat.</p>
      </div>
      <div class="column4"> <span class="icon icon-coffee"></span>
        <div class="title">
...
<div id="copyright" class="container">
  <p> | &copy; Zorro Verbz. All rights reserved. | </p>
</div>
